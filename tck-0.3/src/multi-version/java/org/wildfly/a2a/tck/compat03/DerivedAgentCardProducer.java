 ...
 */
package org.wildfly.a2a.tck.compat03;
...
/**
 * In a multi-version deployment, derives a v1.0 {@link AgentCard} from the v0.3 agent card produced
 * by the v0.3 TCK server, so the server advertises both protocol versions from a single agent card.
 */
@ApplicationScoped
